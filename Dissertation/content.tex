...
For our application, one of the major parts of the project was to retrieve weather data that would then be processed for a rating out of 5, depending on the search type , it would either return multiple ratings for the next twelve hours or a single rating for the current hour.
